...
class MovieActivity : YouTubeBaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent!=null){
            ...
            Picasso.get().load("https://www.themoviedb.org/t/p/w600_and_h900_bestv2/$image").error(R.mipmap.logo).into(
                movieicon)
    ...
    private fun getTrailer() {
        val vedios=MovieService.movieInstance.getTrailer(id.toString())
        vedios.enqueue(object:Callback<VedioList>{
            ...
            override fun onResponse(call: Call<VedioList>, response: Response<VedioList>) {
                ...
                if (result!=null){
                    ...
                    adapter2=TrailerAdapter(this@MovieActivity, trailers )
    ...
    private fun getReviews() {
        ...
        val reviews= MovieService.movieInstance.getReviews(id.toString())
        reviews.enqueue(object:Callback<ReviewList>{
            override fun onResponse(call: Call<ReviewList>, response: Response<ReviewList>) {
                ...
                if (result!=null){
                    ...
                    adapter=ReviewAdapter(this@MovieActivity,reviews)
